package com.xiaohuijun.administrator.progressdialog.svprogresshud;
...
import com.xiaohuijun.administrator.progressdialog.R;
import com.xiaohuijun.administrator.progressdialog.svprogresshud.listener.OnDismissListener;
import com.xiaohuijun.administrator.progressdialog.svprogresshud.view.SVCircleProgressBar;
import com.xiaohuijun.administrator.progressdialog.svprogresshud.view.SVProgressDefaultView;
...
public class SVProgressHUD {
    ...
    public SVProgressHUD(Context context,int gravity,boolean isAnimation){
        this.context = context;
        gravity = gravity;
        initViews();
        initDefaultView();
