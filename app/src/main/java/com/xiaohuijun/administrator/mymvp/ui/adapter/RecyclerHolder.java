...
public class RecyclerHolder extends RecyclerView.ViewHolder {
     ...
     * @return
     */
    public RecyclerHolder setImageByUrl(Context context,int viewId, String url,int resourceId) {
        ImageLoader.load(context,url, (ImageView) getView(viewId),resourceId);
        return this;
    }
}