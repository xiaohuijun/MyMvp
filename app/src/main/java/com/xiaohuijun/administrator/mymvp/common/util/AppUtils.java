...
public class AppUtils {
	 ...
	 * @return
	 */
	public static String getTernimalResolution(Activity context) {
		return getPhoneWidth(context) + "*" + getPhoneHeight(context);
	}
			 ...
			 if (tempString.indexOf("PID") == -1) {
				 if (bIsProcInfo == true) {
					 ...
					 if (columns.length == Length_ProcStat) {
						 ...
						 MLog.d("#"+columns[9]+",PID:"+columns[0]);
	...
	/**
	 * 得到硬件标识
	 * android6.0以后取androidID 6.0获取设备id需要授权体验不好,6.0以前还是取deviceId
	 * @param context
	 * @return
	 */
